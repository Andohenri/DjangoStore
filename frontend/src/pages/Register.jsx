...
const Register = () => {
  return (
    <div className='flex items-center  w-full h-screen bg-gradient-to-br from-black to-[#121286]'>
      <div className='p-10'>
        ...
        <form>
          ...
          <label className='text-white font-semibold block'>Confirm Password</label>
          <input type="password" className='px-4 py-2 bg-gray-300 text-[#0a0808c7] w-[25rem]' placeholder='Confirm your password'/>
          <button type="submit" className='text-white text-2xl bg-cyan-400 px-4 py-2 rounded block mt-4'>Register</button>  
        </form>
      </div>
    </div>
  )
